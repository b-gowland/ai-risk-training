    ...
    business_user: {
      nodes: {
        start: {
          ...
          sub_caption: `The agent had the authority. No one asked whether it should have it.`,
          decision: {
    ...
    executive: {
      nodes: {
        start: {
          ...
          sub_caption: `The answer is: no one explicitly decided it should. The authority was inherited by default.`,
          decision: {
