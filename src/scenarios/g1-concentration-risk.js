...
export const scenario = {
  ...
  regulatory_tags: [`eu-ai-act-article-53`, `nist-ai-rmf-manage-4`, `nist-ai-rmf-govern-5`, `jurisdiction-au`, `jurisdiction-eu`],
    ...
    business_user: {
      nodes: {
        start: {
          ...
          sub_caption: `The manual process didn't disappear — it was just never written down after the AI replaced it.`,
          decision: {
    ...
    executive: {
      nodes: {
        start: {
          ...
          sub_caption: `The outage is the trigger. The underlying problem is the concentration risk that made the outage this consequential.`,
          decision: {
