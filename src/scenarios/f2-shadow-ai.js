...
export const scenario = {
  ...
  kb_url: 'https://b-gowland.github.io/ai-risk-kb/domain-f-hci-deployment/shadow-ai',
          ...
          decision: {
            ...
            choices: [
              { id: 'a', label: 'Just paste it in — it\'ll take two minutes', quality: 'poor',
                note: 'It does take two minutes. The one-pager is great. You are now Priya.' },
              ...
              { id: 'c', label: 'Check if there\'s a company policy first', quality: 'good',
                note: 'There is one. It\'s buried in the intranet under "Governance 2022" but it exists.' },
          ...
          decision: {
            ...
            choices: [
              { id: 'a', label: 'Decide that if everyone does it, it must be fine', quality: 'poor',
                note: '"Everyone does it" has never once been a legal defence. Just so you know.' },
          ...
          decision: {
            ...
            choices: [
              ...
              { id: 'b', label: 'Hard pass — you\'d rather this just quietly went away', quality: 'partial',
                note: 'Fair. It mostly does. You get a written note-to-file. No further action.' },
            ],
          },
          branches: { a: 'outcome_great', b: 'outcome_good' },
        },
          ...
          decision: {
            ...
            choices: [
              ...
              { id: 'b', label: 'Double down — insist the log must be wrong', quality: 'poor',
                note: 'The log is not wrong. IT is very sure of this. You are now a case study.' },
            ],
          },
          branches: { a: 'outcome_warn', b: 'outcome_bad' },
        },
          ...
          decision: {
            ...
            choices: [
              { id: 'a', label: 'Call the chair before the meeting — get ahead of their questions', quality: 'good',
                note: 'They\'re still unhappy. But you\'ve shown initiative. The conversation is shorter than it could have been.' },
          ...
          decision: {
            ...
            choices: [
              ...
              { id: 'b', label: 'No comment', quality: 'poor',
                note: '"Company refuses to comment on AI malpractice scandal." You are now the poster child. The board fires you. Not ideal.' },
            ],
          },
          ...
          decision: {
            ...
            choices: [
              ...
              { id: 'b', label: 'Double down — maybe the log is wrong', quality: 'poor',
                note: 'The log is not wrong. IT is extremely confident of this. You are now a case study in what not to do.' },
            ],
          },
          ...
          decision: {
            ...
            choices: [
              ...
              { id: 'c', label: 'Say nothing — let the others explain it', quality: 'poor',
                note: 'The director points at you specifically. You are now the scapegoat and the person who didn\'t help.' },
            ],
          },
          ...
          decision: {
            ...
            choices: [
              ...
              { id: 'b', label: 'Maintain that you didn\'t know it was that sensitive', quality: 'partial',
                note: 'Plausible. The M&A section was pretty clearly labelled. But plausible.' },
            ],
          },
          ...
          decision: {
            ...
            choices: [
              ...
              { id: 'b', label: 'Hard pass — you\'d rather this whole thing quietly disappeared', quality: 'partial',
                note: 'Understandable. It mostly does. Note to file. No further action.' },
            ],
          },
          ...
          decision: {
            ...
            choices: [
              ...
              { id: 'b', label: 'Claim you\'d flagged this previously (you hadn\'t)', quality: 'poor',
                note: 'Legal asks to see the report. There is no report. You are now part of the incident.' },
            ],
          },
          ...
          decision: {
            ...
            choices: [
              { id: 'a', label: 'Endpoint DLP that covers personal browser sessions', quality: 'good',
                note: 'Closes the specific gap. Slightly expensive. CISO approves it.' },
