...
export const scenario = {
  ...
  regulatory_tags: [`eu-ai-act-article-26`, `nist-ai-rmf-govern-1`, `iso-42001-8`, `jurisdiction-au`, `jurisdiction-eu`],
    ...
    business_user: {
      nodes: {
        start: {
          ...
          sub_caption: `The AI Register said AU scope only. The system didn't know — or wasn't asked — to check.`,
          decision: {
    ...
    pm: {
      nodes: {
        start: {
          ...
          sub_caption: `The register worked. The process around it didn't.`,
          decision: {
