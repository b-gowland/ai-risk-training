...
const IMAGE_SCENES = new Set([
  'analyst-desk',
  'analyst-desk-privacy',
  'desk-working',
  'desk-working-night',
  'office-meeting',
  'office-meeting-hearing',
  'office-meeting-aftermath',
  'boardroom',
  'boardroom-crisis',
  'boardroom-agm',
  'desk-focused',
...
const IMAGE_ALT = {
  ...
  'analyst-desk-privacy':    `Analyst desk with dual monitors showing a data access log and document viewer`,
  'desk-working':            `Corporate office workstation with monitor and keyboard`,
  'desk-working-night':      `Corporate office desk late at night with only monitor glow illuminating the workspace`,
  'office-meeting':          `Modern corporate meeting room with conference table and whiteboard`,
  'office-meeting-hearing':  `Corporate meeting room viewed from the front, chairs facing the viewer as if awaiting answers`,
  'office-meeting-aftermath':`Corporate meeting room after a meeting has concluded, chairs pushed back and documents left on table`,
  'boardroom':               `Formal boardroom with long rectangular table and presentation screen`,
  'boardroom-crisis':        `Formal boardroom in a state of tension with papers in disarray and a red alert on screen`,
  'boardroom-agm':           `Formal meeting room viewed from the presentation end, rows of seats facing the viewer`,
  ...
  'desk-report':             `Corporate desk with a multi-page printed report and highlighter in the foreground`,
  'desk-reading':            `Corporate desk with a single printed document under focused lamp light`,
  'desk-evidence':           `Corporate desk with two printed documents side by side for forensic comparison`,
  'desk-thirty-days':        `Corporate desk with a settled resolved atmosphere, closed notebook and healthy dashboard on screen`,
  'desk-waiting':            `Corporate desk with chair pushed back and a loading indicator on screen, work paused`,
  'desk-call':               `Corporate desk with a telephone handset off its base and notepad with scribbled notes`,
  'office-briefing':         `Meeting area with a notification or alert dashboard on screen`,
  'office-briefing-urgent':  `Meeting area with a red alert on screen and an urgent document on the table`,
...
function getSVGScene(sceneKey) {
  const scenes = {
    ...
    // New image-backed scenes — SVG fallback only (PNG is primary)
    'analyst-desk-privacy':    <AnalystDeskScene />,
    'desk-working-night':      <DeskFocusedScene />,
    'desk-report':             <DeskReviewScene />,
    'desk-reading':            <DeskReviewScene />,
    'desk-evidence':           <DeskReviewScene />,
    'desk-thirty-days':        <OfficeReviewScene />,
    'desk-waiting':            <DeskFocusedScene />,
    'desk-call':               <DeskWorkingScene />,
    'boardroom-crisis':        <BoardroomScene />,
    'boardroom-agm':           <BoardroomScene />,
